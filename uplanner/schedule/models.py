...
class Section(models.Model):
    ...
    clss = models.ForeignKey(Class, on_delete='CASCADE', help_text='The corresponding generic class for this section')
    COMPONENTS = (
        ('col', 'Colloquium'),
        ('dis', 'Discussion'),
...
class Schedule(models.Model):
    ...
    #courses = models.ForeignKey(ScheduleClass, on_delete=SET_NULL, null=True)
